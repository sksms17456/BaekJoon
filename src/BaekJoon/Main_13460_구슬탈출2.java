...
//
//빨간 구슬과 파란 구슬의 크기는 보드에서 1×1크기의 칸을 가득 채우는 사이즈이고, 각각 하나씩 들어가 있다. 게임의 목표는 빨간 구슬을 구멍을 통해서 빼내는 것이다. 이때, 파란 구슬이 구멍에 들어가면 안된다.
//
...
public class Main_13460_구슬탈출2 {
	static int N, M, redr, redc, blur, bluc, holr, holc, direc;
	static int[][] pos = {{-1,0},{1,0},{0,-1},{0,1}};//상하좌우
	static char[][] board;
	
	public static void main(String[] args) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("res/Main_13460_구슬탈출2.txt"));
