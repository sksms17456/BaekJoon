...
//
//캠프에 사용할 문제는 두 문제 이상이어야 한다. 문제가 너무 어려우면 학생들이 멘붕에 빠지고, 문제가 너무 쉬우면 학생들이 실망에 빠지게 된다. 
//
...
public class Main_16938_캠프준비 {
	static int N, L, R, X, len, sum, cnt=0, min, max;
	static int[] difficulty;
	public static void main(String[] args) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("res/Main_16938_캠프준비.txt"));
