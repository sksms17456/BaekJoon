...
//
//만약 첫째 줄에서 1과 3을 뽑으면, 이들 바로 밑에는 정수 3과 1이 있으므로 두 집합이 일치한다. 그러나, 이 경우에 뽑힌 정수의 개수는 최대가 아니므로 답이 될수 없다.
//
//입력
//
...
public class Main_2668_숫자고르기 {
	static int N, cnt, samecnt, max = Integer.MIN_VALUE;
	static int[] arr;
	static boolean[] visit;
	static PriorityQueue<Integer> q, temp;
	public static void main(String[] args) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("res/Main_2668_숫자고르기.txt"));
