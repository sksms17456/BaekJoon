...
public class Main_3613_javaVScpp {
	public static void main(String[] args) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader("res/Main_3613_javaVScpp.txt"));
//		BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
		...
		if(line.contains("_")) {
			...
			newline = String.valueOf(arr).replaceAll("_", "");
		}else {
